...
public class EnvironmentsController {
    ...
    @PreAuthorize("hasAuthority('CVM_ADMIN')")
    @Operation(summary = "Umgebung soft-loeschen (CVM_ADMIN). Scans bleiben erhalten.")
    public ResponseEntity<Void> loeschen(@PathVariable UUID environmentId) {
        service.loesche(environmentId);
